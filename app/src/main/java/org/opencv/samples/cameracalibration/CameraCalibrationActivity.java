...
public class CameraCalibrationActivity extends Activity implements CvCameraViewListener2, OnTouchListener {
            ...
            new AsyncTask<Void, Void, Void>() {
                ...
                protected void onPostExecute(Void result) {
                    ...
                    if (mCalibrator.isCalibrated()) {
                        ...
                        CalibrationResult.saveToFile(mCalibrator.getCameraMatrix(),
    ...
    public void onCameraViewStarted(int width, int height) {
        if (mWidth != width || mHeight != height) {
            ...
            if(CalibrationResult.loadFromFile(this, mCalibrator.getCameraMatrix(), mCalibrator.getDistortionCoefficients())) {
                mCalibrator.setCalibrated();
            } else if (CalibrationResult.tryLoad(this, mCalibrator.getCameraMatrix(), mCalibrator.getDistortionCoefficients())) {
                mCalibrator.setCalibrated();
            }
