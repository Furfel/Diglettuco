...
public class MarkerDetector {
	...
	private Vector<Marker> candidateMarkers = new Vector<Marker>();
	private Vector<Marker> newMarkers = new Vector<Marker>();
	 ...
	 */
	public void detect(Mat in, Mat gray, Vector<Marker> detectedMarkers, CameraParameters cp,//Mat camMatrix, Mat distCoeff,
			float markerSizeMeters){
		if(gray!=null) grey=gray;
		else Imgproc.cvtColor(in, grey, Imgproc.COLOR_RGBA2GRAY);
